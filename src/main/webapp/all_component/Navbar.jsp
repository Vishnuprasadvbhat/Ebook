...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-3">
			<a href="loginpage.jsp" class="btn btn-success"><i
				class="fa-solid fa-person-walking"></i> Login</a> <a href="register.jsp"
				class="btn btn-primary "><i class="fa-solid fa-door-open"></i>
				Register</a>
